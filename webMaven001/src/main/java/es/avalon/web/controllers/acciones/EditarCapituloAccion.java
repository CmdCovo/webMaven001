...
@Component
public class EditarCapituloAccion extends Accion {
	...
	public void ejecutar(HttpServletRequest request, HttpServletResponse response)
		...
		Capitulo c = sl.buscarCapituloPorTitulo(request.getParameter("titulo"));
		request.setAttribute("titulo", request.getParameter("titulo"));
		request.setAttribute("capitulo", c);
		despachar(request, response, "editar.jsp", "vistas/capitulo/");
