...
@Component
public class UpdateCapituloAccion extends Accion {
	...
	public void ejecutar(HttpServletRequest request, HttpServletResponse response)
		...
		Capitulo l = new Capitulo(request.getParameter("titulo"), Integer.parseInt(request.getParameter("paginas")));
		
		sl.actualizarCapitulo(request.getParameter("tituloOG"), request.getParameter("libro_titulo") , l);
