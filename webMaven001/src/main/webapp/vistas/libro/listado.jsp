...
<td>
<div class="botonVer">
<a class="botonText" href="./ServletFrontController?accion=editarLibro&titulo=${l.getTitulo()}">Ver</a>
</div>
</td>

<td>
<div class="botonBorrar">
<a class="botonText" href="./ServletFrontController?accion=borrarLibro&titulo=${l.getTitulo()}">Borrar</a>
</div>
</td>
</tr>
</c:forEach>
